  ...
  return (
    <div className="relative z-50 flex flex-col max-w-4xl gap-20 px-4 mx-auto mt-20 text-sm text-justify md:px-8">
      ...
      <div
        ...
        <div className="">
          <h2 className="text-xl text-center md:text-start md:text-2xl">DECENTRALISED MEDIA</h2>
          <p className="max-w-sm mt-8 text-sm md:max-w-lg md:text-base">
            Creators can post their Podcasts on Excalibur. There is the option to gate the content so that the listener
            is required to make a bitcoin lightning payment before they listen. Some content may be given away for free
            and the listener has the option to give a tip using the Bitcoin wallet that they have connected.
          </p>
        </div>
      </div>
      <div
        ...
        {' '}
        <div>
          <h2 className="flex text-xl text-center md:text-start md:text-2xl">AUDIOBOOKS</h2>
          <p className="max-w-sm mt-8 text-sm md:max-w-lg md:text-base">
            Share your Audiobook on Excalibur and your network can recommend it to their friends. The first chapter
            could be made free to access while the rest of the book requires the Bitcoin payment to gain access.
          </p>
        </div>
      ...
      <div
        ...
        <div>
          ...
          <p className="max-w-sm mt-8 text-sm sm:mx-auto md:mx-0 md:max-w-lg md:text-base">
            Your customers can make comments when they share work. Discussions that follow can be valuable feedback for
            your creative efforts. You can reward your customers with sats when they share your content and help build
