  ...
  return (
    <div className="relative flex flex-col items-center content-center justify-center w-full px-8 mx-auto mt-32">
      ...
      <div className="w-full lg:w-3/4">
        <h2 id="e2e-general-heading" className="block mt-8 text-xl font-semibold md:text-2xl">
          General
        </h2>
        <FaqBox
          ...
          <p id="e2e-how-it-works-text" className="block mt-2 transition-all duration-1000">
        ...
        <h2 className="block mt-8 text-xl font-semibold md:text-2xl">For Creators</h2>
        <FaqBox boxNumber={3} setBoxState={setBoxState} boxState={boxState} boxTitle={'How does Excalibur work?'}>
          <ol>
            <li>
              <p className="">
                - Excalibur is a Decentralised Media Platform where creators can monetize their audio content by
                receiving payments from listeners. It&apos;s a decentralized space where creators can build a loyal and
                an engaged community. Excalibur provides an additional revenue stream for podcasters in an industry
                where other revenue sources can be unpredictable
              </p>
            </li>
            {/* <li>
              <p className="">
        ...
        <h2 className="block mt-8 text-xl font-semibold md:text-2xl">For Listeners and Community Members</h2>
        <FaqBox boxNumber={5} setBoxState={setBoxState} boxState={boxState} boxTitle={'Why would I use Excalibur?'}>
          <ol>
            <li>
              <p className="">
                Excalibur gives you the chance to find and share great content through your social network. You can
                comment , share and engage in discussions about the content that you have found. Additionally you have
                the opportunity to support the creators through peer to peer payments in Bitcoin.
              </p>
            </li>
            {/* <li>
              <p className="">
        ...
        <h2 className="block mt-8 text-xl font-semibold md:text-2xl">Your Wallet</h2>
        <FaqBox
          boxNumber={7}
          setBoxState={setBoxState}
          boxState={boxState}
          boxTitle={'What is a Bitcoin Lightning Wallet?'}>
          <p className="">This is a digital wallet that allows you transfer bitcoin instantly at virtually no cost.</p>
        </FaqBox>
        <FaqBox boxNumber={8} setBoxState={setBoxState} boxState={boxState} boxTitle={'Which wallet should I use?'}>
          <p className="">
            There are many Bitcoin Lightning wallets available. We recommend that you download one at getalby.com and
