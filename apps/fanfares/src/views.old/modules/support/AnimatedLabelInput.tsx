    ...
    <div className="relative w-full mt-4">
      {props.messageField ? (
        <>
          <textarea
            required
            onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => props.onChange}
            id={props.htmlFor}
            autoComplete="off"
      ...
      <label
        ...
        className={`absolute left-0  w-full ${
          isFocused || hasValue ? '-top-2 text-xs text-buttonAccentHover' : 'top-1/2 -translate-y-1/2 text-gray-500'
