...
> = (set, get) => {
    ...
    const submit = async () => {
        ...
        try {
            ...
            if(!response.ok) throw new Error(`Error sending email - ${response.statusText}`);
...
export const useFeedbackFormLoading = () => useFeedbackFormSlice((state) => state.feedbackFormLoading);
export const useFeedbackFormLud16 = () => useFeedbackFormSlice((state) => state.feedbackLud16);
export const useFeedbackFormPublicKey = () => useFeedbackFormSlice((state) => state.feedbackPublicKey);
export const useFeedbackFormEmail = () => useFeedbackFormSlice((state) => state.feedbackEmail);
export const useFeedbackFormMessage = () => useFeedbackFormSlice((state) => state.feedbackMessage);
export const useFeedbackFormActions = () => useFeedbackFormSlice((state) => state.actions);
