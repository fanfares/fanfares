  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        <button
          className="rounded-full w-[35px] h-[35px] inline-flex items-center justify-center text-violet-100 bg-transparent shadow-[0_2px_10px] shadow-black outline-none hover:bg-skin-button-accent-hover focus:shadow-[0_0_0_2px] focus:shadow-transparent"
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          ...
          <DropdownMenu.Item
            ...
            className="group text-[13px] leading-none text-violet11 rounded-[3px] flex gap-2 items-center h-[25px] px-[5px] relative pl-[25px] select-none outline-none data-[disabled]:text-mauve8 data-[disabled]:pointer-events-none data-[highlighted]:bg-violet9 data-[highlighted]:text-violet1">
          ...
          <DropdownMenu.Item className="group text-[13px] leading-none text-violet11 rounded-[3px] flex gap-2 items-center h-[25px] px-[5px] relative pl-[25px] select-none outline-none data-[disabled]:text-mauve8 data-[disabled]:pointer-events-none data-[highlighted]:bg-violet9 data-[highlighted]:text-violet1">
